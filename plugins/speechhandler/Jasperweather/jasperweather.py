...
#re.search(r'\b(CURRENT|TODAYS|TODAY)\b',text,re.IGNORECASE)
#if self.gettext("WEATHER") and self.gettext("TODAY"):
        if self.gettext('WEATHER').upper() and self.gettext("TODAY") in text.upper():
